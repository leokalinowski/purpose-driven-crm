...
export interface DatabaseStats {
  ...
  pastClients: number;
  // hotLeads (priority_score >= 60) was dropped 2026-05-18 — the set-based
  // priority rewrite made priority_score NULL for every row and the tile
  // it fed was already replaced by the "Priorities" tile that reads
  // `usePrioritizedQueue().counts` directly. No UI consumer remained.

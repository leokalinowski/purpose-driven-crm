...
interface ContactRecord {
  ...
  // priority_score + priority_components were removed when the priority
  // model went set-based (2026-05-18). The DB columns still exist but
  // are NULL for every row — no UI reader consumes them.
...
// CoachPane dead helpers (signalLabels, isMeaningful, humanizeSignalString,
// buildHumanSignals, SignalsView, COMPONENT_ORDER, ComponentBar) removed
// 2026-05-18 — set-based-v7 priority model has no score / no weight bars.
/**

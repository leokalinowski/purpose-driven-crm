...
export const DEFAULT_EVENT_TASKS: DefaultTaskTemplate[] = [
  ...
  { task_name: 'Draft Event Budget',                       phase: 'pre_event', days_offset: -60, responsible_person: 'Event Coordinator' },
  { task_name: 'Request Sponsor Commitments',              phase: 'pre_event', days_offset: -55, responsible_person: 'Event Coordinator' },
  { task_name: 'Confirm charity (if applicable)',           phase: 'pre_event', days_offset: -50, responsible_person: 'Event Coordinator' },
  { task_name: 'Create Facebook & LinkedIn Events',        phase: 'pre_event', days_offset: -42, responsible_person: 'Marketing' },
  { task_name: 'Provide Materials to Sponsors',            phase: 'pre_event', days_offset: -40, responsible_person: 'Marketing' },
  ...
  { task_name: 'Confirm Venue',                            phase: 'pre_event', days_offset: -35, responsible_person: 'Event Coordinator' },
  ...
  { task_name: 'Agent Call/Text Round #1',                  phase: 'pre_event', days_offset: -30, responsible_person: 'Event Coordinator' },
  ...
  { task_name: 'Order Event Signage & Printed Materials',  phase: 'pre_event', days_offset: -21, responsible_person: 'Event Coordinator' },
  ...
  { task_name: 'Send Day-Of Agenda to Team',               phase: 'pre_event', days_offset: -2,  responsible_person: 'Event Coordinator' },
  { task_name: 'Remind Sponsors',                          phase: 'pre_event', days_offset: -1,  responsible_person: 'Event Coordinator' },
  { task_name: 'Final Walkthrough with Venue',             phase: 'pre_event', days_offset: -1,  responsible_person: 'Event Coordinator' },
  ...
  { task_name: 'Sponsor Thank-Yous',                       phase: 'post_event', days_offset: 5,  responsible_person: 'Event Coordinator' },
  { task_name: 'KPI Report & Scoreboard Entry',            phase: 'post_event', days_offset: 7,  responsible_person: 'Event Coordinator' },
  { task_name: 'Archive Assets',                           phase: 'post_event', days_offset: 14, responsible_person: 'Marketing' },
];

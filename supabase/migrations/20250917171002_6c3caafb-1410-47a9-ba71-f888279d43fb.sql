-- PHASE 1: CRITICAL ROLE ESCALATION FIX (FINAL)
...
CREATE POLICY "Secure profile updates with role protection" 
ON public.profiles 
FOR UPDATE 
...
-- PHASE 2: STRENGTHEN RLS POLICIES FOR DATA PROTECTION

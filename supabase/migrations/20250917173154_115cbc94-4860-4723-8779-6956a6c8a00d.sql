-- SECURITY FIX: Replace SECURITY DEFINER view with properly secured view (CORRECTED)
...
SELECT 
    ...
    (CASE 
        ...
        ELSE email
    END) AS email_masked,
    -- Direct masking for phone without SECURITY DEFINER function (handle numeric type)
    (CASE 
